...
import threading
import numpy as np
from armpy.perception.CameraCalibration.CalibrationConfig import *
...
class Camera:
    def __init__(self, resolution=(640, 480)):
        ...
        self.th = threading.Thread(target=self.__camera_thread__, args=(), daemon=True)
        self.th.start()
